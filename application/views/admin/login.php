    ...
    <div class="login-box">
        ...
        <?php
            if(!empty($this->session->flashdata("msg"))){
                echo "<div class='alert alert-danger pb-3'>" . $this->session->flashdata('msg') . "</div>";
            }
        ?>
        <!-- /.login-logo -->
        <div class="card">
            ...
            <form action="<?php echo base_url() ?>admin/login/authenticate" name="loginFrom" id="loginFrom" method="post">
